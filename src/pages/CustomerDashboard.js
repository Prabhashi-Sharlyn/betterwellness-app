    ...
    const fetchCounsellors = async () => {
      try {
        const response = await fetch(
          ...
          "https://ga73dgtivj.execute-api.ap-south-1.amazonaws.com/users/counsellors"
        );
    ...
    const fetchUpcomingAppointments = async () => {
      try {
        ...
        const response = await fetch(
          ...
          `https://ga73dgtivj.execute-api.ap-south-1.amazonaws.com/booking/customer/${user.uuid}`
        );
  ...
  const sendChatRequest = async (selectedCounsellor) => {
    try {
      const response = await fetch(
        ...
        "https://ga73dgtivj.execute-api.ap-south-1.amazonaws.com/messaging/sendRequest",
        {
          method: "POST",
          headers: {
